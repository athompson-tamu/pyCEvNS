...
def main():
    ...
    flux = np.genfromtxt("data/dune_binned_pythia8_gamma_pot_per_s_2d.txt")
    flux_5pc = np.genfromtxt("data/dune_binned_pythia8_gamma_pot_per_s_2d.txt")
    ...
    # Run the scan.
    save_dir = "limits/dune_target_limits.txt"
    ...
    plt.title(r"Primakoff Scattering and $a\to\gamma\gamma$, 50t fiducial mass, 10 year exposure", loc="right")
    plt.xscale('log')
    plt.yscale('log')
    plt.xlim((1,1e10))
    plt.ylim(1e-13,1e-1)
