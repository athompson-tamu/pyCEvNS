...
dm_pim = DMFluxFromPiMinusAbsorption(dark_photon_mass=138, life_time=1, coupling_quark=g, dark_matter_mass=5)
dm_flux_long_heavy = DMFluxIsoPhoton(photon_flux, dark_photon_mass=138, coupling=g, dark_matter_mass=m_chi, life_time=1, sampling_size=5000)


dm_flux_short = DMFluxIsoPhoton(photon_flux, dark_photon_mass=m_dp, coupling=g, dark_matter_mass=m_chi, life_time=1e-3, sampling_size=5000)
dm_flux_medium = DMFluxIsoPhoton(photon_flux, dark_photon_mass=m_dp, coupling=g, dark_matter_mass=m_chi, life_time=0.1, sampling_size=5000)
dm_flux_long = DMFluxIsoPhoton(photon_flux, dark_photon_mass=m_dp, coupling=g, dark_matter_mass=m_chi, life_time=1, sampling_size=5000)
