...
def PlotSpectra(flux, mass, coupling):
    ...
    # Simulate
    axion_sim = IsotropicAxionFromCompton(flux, mass, 100*coupling, 240e3, 90, 15e-24, det_dis, 0)
    axion_sim.simulate()
    electron_scatter_events = axion_sim.scatter_events_binned(det_mass * mev_per_kg / det_am, det_z,
                                                              days*s_per_day, 1e-5)

    axion_sim_primakoff = IsotropicAxionFromPrimakoff(flux, mass, coupling, 240e3, 90, 15e-24, det_dis, 0)
