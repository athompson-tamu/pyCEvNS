...
def survival_const(ev, length=0.0, epsi=NSIparameters(), op=oscillation_parameters(),
                   ne=1.5 * 6.02e23 * (100 * meter_by_mev) ** 3, nui='e', nuf='e'):
    """
...
def survival_sterile(ev, dm41=0, ua4=(0, 0, 0), epsi=NSIparameters(), op=oscillation_parameters(), nui='e', nuf='e',
                     lenth=19.3 / meter_by_mev):
