...
# Plot fluxes.
axion_sim1 = MinerEstimate(flux, 1, 1e-4, 240e3, 90, 15e-24, det_dis, 0)
axion_sim2 = MinerEstimate(flux, 0.1, 1e-4, 240e3, 90, 15e-24, det_dis, 0)
axion_sim3 = MinerEstimate(flux, 0.01, 1e-4, 240e3, 90, 15e-24, det_dis, 0)
axion_sim1.simulate()
axion_sim2.simulate()
axion_sim3.simulate()

alp1_e = axion_sim1.axion_energy
alp2_e = axion_sim2.axion_energy
alp3_e = axion_sim3.axion_energy
alp1_w = axion_sim1.axion_weight
alp2_w = axion_sim2.axion_weight
alp3_w = axion_sim3.axion_weight

print(alp1_w)
plt.hist(alp1_e, weights=alp1_w)
plt.show()
plt.clf()
